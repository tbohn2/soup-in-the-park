...
import loadingLogo from '../assets/trumpSanty.png';
import '../styles/signUp.css';
// const DEPLOYMENT_ID = import.meta.env.VITE_DEPLOYMENT_ID;
const DEPLOYMENT_ID = 'AKfycbypf8wZLgo5EwE_zCrxyjDQuuQSkzmMP2B_-vwTdegjrooHC00L0hlIce6IrTNu64s4SA';
...
const ChristmasSignUp = ({ mobile }) => {
    ...
    return (
        <div className='fade-in main-content fw-light d-flex flex-column align-items-center'>
            <div id='date-time'>
                <h1 className='chewy fs-3'>December 23, 2024</h1>
                <h1 className='chewy fs-3'>6:00 PM</h1>
            </div>
